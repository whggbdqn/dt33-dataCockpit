  ...
  <div class="content-wrapper">
    ...
    <section class="content">  
      ...
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
		<form method="post" action="${pageContext.request.contextPath}/noticeInfo/updateNoticeInfo.action?id=${noticeInfo.id}" >
          <!-- general form elements disabled -->
          <div class="box box-warning"  style="margin-left:150px ;border: solid  #D2D6DE 3px;width: 700px">
            <div class="box-header with-border">
            	<div style="font-size: 14px">编辑公告
              		<input type="submit" value="保存" style="margin-left: 500px;width:100px"  onclick="return confirm('确认修改内容？')"/>
            	</div>
            </div>
             <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="form-group">
                  <label>公告标题</label>
                  <input type="text" class="form-control" value="${noticeInfo.title}" name="title" >
                </div>
                <div class="form-group">
                  <label>公告作者</label>
                  <input type="text" class="form-control" value="${noticeInfo.publisher}" name="publisher">
                </div>

                <!-- textarea -->
                <div class="form-group">
                  <label>正文</label>
                  <textarea class="form-control" rows="10" name="details">${noticeInfo.details}</textarea>
                </div>
            </div>
          </div>
        </form>
