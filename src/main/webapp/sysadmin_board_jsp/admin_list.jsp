        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a href="${pageContext.request.contextPath }/sysadmin_board_jsp/add_admin.jsp"><span class="glyphicon glyphicon-plus"></span>新增账号</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach items="${page.list}" var="adminInfo" varStatus="count">
                  <tr>
             		...
             		<td><a onclick="return confirm('确定要删除吗？')" href="${pageContext.request.contextPath}/userInfo/deleteAdmin.action?id=${adminInfo.id}">删除</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/userInfo/selectByPrimaryKey.action?id=${adminInfo.id}">修改</a></td>
                  </tr>
                  </c:forEach>
               </tbody>
              </table>
          <a href="${pageContext.request.contextPath }/userInfo/page.action?index=1&firstcondition=${page.querycondition.firstcondition}&pageSize=${page.pageSize}&secondcondition=${page.querycondition.secondcondition}" >首页</a>
		  <c:if test="${page.index==1}">
		       上一页
		 </c:if>
		   <c:if test="${page.index  >1}">
		    <a href="${pageContext.request.contextPath }/userInfo/page.action?index=${page.index-1}&firstcondition=${page.querycondition.firstcondition}&pageSize=${page.pageSize}&secondcondition=${page.querycondition.secondcondition}" >上一页</a>
		 </c:if>
		    <c:if test="${page.index < page.totalPage}">
		     <a href="${pageContext.request.contextPath }/userInfo/page.action?index=${page.index+1}&firstcondition=${page.querycondition.firstcondition}&pageSize=${page.pageSize}&secondcondition=${page.querycondition.secondcondition}" >下一页</a>
		 </c:if>
		<c:if test="${page.index == page.totalPage}">
		      下一页
		 </c:if>
		   <a href="${pageContext.request.contextPath }/userInfo/page.action?index=${page.totalPage}&firstcondition=${page.querycondition.firstcondition}&pageSize=${page.pageSize}&secondcondition=${page.querycondition.secondcondition}" >末页</a> 
