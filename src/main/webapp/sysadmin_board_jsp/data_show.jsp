					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h6 class="box-title">数据表管理</h6>
								<%-- <input type="button" value="上传新数据"
									onclick="javascript:var a = ${tid} ;OpenDiv(a);">  --%>
									<input type="button" value="导出数据" onclick="OpenDiv2()" class="startNew">
									<span style="margin-left:450px;font-size:16px;">最近一次的更新时间:</span>
							</div>
							<!-- /.box-header -->
							<div class="box-body">
								<table id="example2" class="table table-bordered table-hover" style="text-align:center;">
									<thead style="text-align:center;">
										<tr style="background-color:#DEE5F7;">
											<th class="col-lg-1"  style="text-align:center;">编号</th>
											<c:forEach var="cname" items="${tableColumnName}">
												<th class="col-lg-2" style="text-align:center;">${cname.columnName}</th>
											</c:forEach>
										</tr>
									</thead>
									<tbody id="domId">
										...
										<table style="margin-left: 50px">
											...
											<tr>
												<td colspan="3">&nbsp;<input type="hidden" value="${tid}"
													name="cdr_id"> <span id="tips" style="color: red">123</span></td>
											</tr>

											<tr>
												<td><input type="submit" value="确定上传"
													onclick="javascript:Validate();"></td>
												<td><input style="margin-left: 100px" type="button"
								...
								<div id="div2">
									...
									<form
										...
										method="post">
										<div><span style="margin-left:15px;font-weight:bold;">请选择文件格式：</span><br/></div>
										<center>
										<input type="hidden" value="${tid}" name="tid">
										<label class="radio-inline">
                                           <input type="radio" name="fileType" id="optionsRadios3" value="xls" checked style="width:20px;height:20px;"> 
                                           <span style="font-size:20px;">excel</span>
                                        </label>
										<label class="radio-inline">
                                           <input type="radio" name="fileType" id="optionsRadios3" value="csv" style="width:20px;height:20px;"> 
                                           <span style="font-size:20px;">csv</span>
                                        </label>
										<br/><br/>
