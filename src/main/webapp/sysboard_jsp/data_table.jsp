				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown notifications-menu">
							...
							href="${pageContext.request.contextPath}/sysboard_jsp/change_pwd.jsp"
							class="dropdown-toggle" data-toggle="dropdown"> <i
								class="fa fa-cog">&nbsp;修改密码</i>
						</a>
						...
						<div class="box">
							...
							<div class="box-body">
								...
								<table id="example2" class="table table-bordered table-hover">
									<thead>
										<tr>
											<th class="col-lg-3">编号</th>
											<th class="col-lg-3">数据表名</th>
											<th class="col-lg-3">最近数据更新时间</th>
									...
									<tbody>
										<!-- vs id自增 -->
										<c:forEach var="cdr" items="${pages.list}" varStatus="vs">
											<tr>
												<td>${vs.count+(page.index-1)* page.pageSize}</td>
												<td>${cdr.name}</td>
												<td><fmt:formatDate value="${cdr.updatetime }" /></td>
												<td><a href="javascript:var a ='${cdr.id}';OpenDiv(a);">上传数据</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
													href="${pageContext.request.contextPath}/showdata.action?pageNow=1&id=${cdr.id}">查看数据</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
								...
								<div id="div1">
									...
									<form
										...
										<table style="margin-left: 50px">
											...
											<tr>
												<td colspan="3">&nbsp;<input type="hidden" id="cdrid"
