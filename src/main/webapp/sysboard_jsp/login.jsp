...
<head>
  ...
  <script type="text/javascript">
     function randomImage(){
    	 ...
    	 image.src="${pageContext.request.contextPath }/validatecode.jsp?rand="+new Date();
     }
  </script>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <form action="${pageContext.request.contextPath }/jumpPage/toIndexPage.action" method="post">
      <div class="form-group has-feedback">
        <input type="tel" class="form-control" name="username1" placeholder="手机号码">
      ...
      <div class="row">
      <div class="col-xs-6 form-group has-feedback "  style="border:0px red solid;width:200px;">
        <input type="text" class="form-control" name="randomcode" placeholder="请输入验证码">
       
      </div> 
      <div >
           <img src="${pageContext.request.contextPath }/validatecode.jsp" id="validateCode" 
           alt="图片丢失了" style="width:90px;height:32px;" onclick="randomImage();"/> &nbsp;&nbsp;&nbsp;
           <a href="javascript:randomImage();">看不清</a>
      </div>
