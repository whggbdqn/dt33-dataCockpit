    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <center><h1>${noticeInfo.title }</h1></center>
          <br/>
          <span class="col-md-2">发布时间：<fmt:formatDate value="${noticeInfo.publishdate }"/>  </span>
          <span class="col-md-8"></span>
          <span class="col-md-2">发布人：${noticeInfo.publisher}</span>
        </div>
        <div class="box-body">
          ${noticeInfo.details }
        </div>
