...
<head>
  ...
  <script type="text/javascript">
	   ...
	   function relation(id){
		   ...
		   location="${pageContext.request.contextPath}/tid_dataRelation.action?tid="+id;
	  	}
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="#">数据管理
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/cid_dataRelation.action?cid=${companyInfomation.id}">数据关系图</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                <thead>
                <tr >
                	<c:forEach var="info" items="${cdr}">
                 <th class="col-lg-1" style="height: 100px; text-align: center; line-height: 100px;"><span onclick="relation(${info.id})">${info.name}</span></th>
                	</c:forEach>
                </tr>
                </thead>
